...
| **Tests** | 285 passing offline in ~2.7s, no credentials required |
...
**285 tests, ~2.7s, no API key and no cloud credentials needed.** The suite is
...
backend/tests/           285 offline tests
