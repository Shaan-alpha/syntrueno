...
| **Tests** | 284 passing offline in ~2.7s, no credentials required |
...
**284 tests, ~2.7s, no API key and no cloud credentials needed.** The suite is
...
backend/tests/           284 offline tests
